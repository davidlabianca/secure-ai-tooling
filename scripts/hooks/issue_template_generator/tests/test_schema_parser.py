...
- load_schema(): 11 tests
- extract_enum_values(): 17 tests
- get_required_fields(): 9 tests
- extract_all_enums(): 7 tests
- Integration (Production Schemas): 11 tests
...
- Enum value extraction (simple, nested, complex)
- Required field extraction
- All-enum discovery
- Production schema validation
- Error handling (FileNotFoundError, JSONDecodeError, KeyError, TypeError)
- Path resolution with dot notation
- Performance characteristics
- Edge cases (empty values, missing keys, malformed data)

Expected Coverage: 90%+ of SchemaParser code

Next Steps:
1. Implement SchemaParser class at:
   /workspaces/secure-ai-tooling/scripts/hooks/issue_template_generator/schema_parser.py
2. Run tests: pytest scripts/hooks/issue_template_generator/tests/test_schema_parser.py
3. Iterate on implementation until all tests pass
4. Verify coverage: pytest --cov=scripts/hooks/issue_template_generator/schema_parser
"""
