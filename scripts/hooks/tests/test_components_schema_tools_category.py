...
ADR-030 D1 (docs/adr/030-agentic-component-model.md, "Schema impact"):
  ...
  componentsToolControlPlane and componentsToolDataPlane; a new componentsExternalTools branch
...
This module tests the enum-level surface of that change:
  ...
  - definitions/subcategory/properties/id/enum gains 'componentsToolControlPlane'
    and 'componentsToolDataPlane'
...
restricting subcategory to exactly {componentsToolControlPlane,
componentsToolDataPlane}) is covered by the extended TestSchemaContainsPairingConstraint
...
class TestSubcategoryIdEnumGainsToolSubcategories:
    ...
    def test_subcategory_enum_has_at_least_ten_members(self, subcategory_id_enum: list):
        ...
        assert len(subcategory_id_enum) >= 10, (
            ...
            f"componentsToolControlPlane + componentsToolDataPlane); got "
...
- TestSubcategoryIdEnumGainsToolSubcategories.test_new_subcategory_in_enum[componentsToolControlPlane]
- TestSubcategoryIdEnumGainsToolSubcategories.test_new_subcategory_in_enum[componentsToolDataPlane]
