...
graph LR
   %%{init: {'flowchart': {'nodeSpacing': 30, 'rankSpacing': 40, 'padding': 5, 'wrappingWidth': 250}}}%%
    ...
    subgraph risks
    subgraph risksModelTraining ["Model Training Risks"]
        DP[Data Poisoning]
        UTD[Unauthorized Training Data]
    end

    subgraph risksAiSystemIntegrity ["Ai System Integrity Risks"]
    ...
    subgraph risksAiSystemAccess ["Ai System Access Risks"]
        EDH[Excessive Data Handling]
    end

    subgraph risksModelLoss ["Model Loss Risks"]
        MRE[Model Reverse Engineering]
        MXF[Model Exfiltration]
    end

    subgraph risksAiAdversarial ["Ai Adversarial Risks"]
        MEV[Model Evasion]
        PIJ[Prompt Injection]
    end

    subgraph risksDataControl ["Data Control Risks"]
        ISD[Inferred Sensitive Data]
        SDD[Sensitive Data Disclosure]
    end

    subgraph risksUnexpectedOutput ["Unexpected Output Risks"]
...
%% Node style definitions
    style risksModelTraining fill:#ffeef0,stroke:#e91e63,stroke-width:2px
    style risksAiSystemIntegrity fill:#ffeef0,stroke:#e91e63,stroke-width:2px
    style risksAiSystemAccess fill:#ffeef0,stroke:#e91e63,stroke-width:2px
    style risksModelLoss fill:#ffeef0,stroke:#e91e63,stroke-width:2px
    style risksAiAdversarial fill:#ffeef0,stroke:#e91e63,stroke-width:2px
    style risksDataControl fill:#ffeef0,stroke:#e91e63,stroke-width:2px
    style risksUnexpectedOutput fill:#ffeef0,stroke:#e91e63,stroke-width:2px
