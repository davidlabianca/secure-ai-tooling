...
| [030](030-agentic-component-model.md) | Agentic component model — model-access boundary, enforcement-point individuation, and the external tools tier | Accepted | 2026-07-29 |
...
| [033](033-vendor-neutral-agent-skill-shipping.md) | Vendor-neutral shipping and lifecycle for CoSAI agents and skills — canonical-only neutral cloneable artifacts, the neutrality contract (machine-checkable denylist + framework-authority allowlist), consumer adaptation, required neutrality check, develop/eval/expand lifecycle | Accepted (D6 extended by two Draft amendments — [2026-07-30](033-vendor-neutral-agent-skill-shipping.md#amendment-2026-07-30-corpus-state-dependent-eval-expectations-ship-with-a-pinned-fixture) fixture grounding, [2026-08-20](033-vendor-neutral-agent-skill-shipping.md#amendment-2026-08-20-portable-agent-evals-ship-in-a-sibling-eval-tree) agent-eval layout) | 2026-07-08 |
